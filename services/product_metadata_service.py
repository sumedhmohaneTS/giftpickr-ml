...
class ProductMetadataService:
    ...
    def get_product_metadata_by_id(self, product_id):
        product_metadata = self.product_metadata_repository.get_product_metadata_by_id(
            product_id)
        return product_metadata

    def get_product_metadata(self, age=None, gender=None, occasion=None, relationship=None, interests=None):
        product_metadata = self.product_metadata_repository.get_product_metadata(
